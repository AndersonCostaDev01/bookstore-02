...
class Category(models.Model): # Modelo de categoria de produtos
    ...
    description = models.TextField(max_length=500, blank=True, null=True) # Descrição da categoria
...
class Product(models.Model): # Modelo de produtos
    ...
    description = models.TextField(max_length=500, blank=True, null=True) # Descrição do produto
    ...
    categories = models.ManyToManyField('Category', blank=True) # Categorias do produto, relacionamento muitos para muitos 